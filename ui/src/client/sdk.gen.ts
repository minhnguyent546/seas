...
import type {
  AuthLoginForAccessTokenData,
  AuthLoginForAccessTokenResponse,
  AuthSignupData,
  AuthSignupResponse,
  ...
  ChatsCreateChatSessionData,
  ChatsCreateChatSessionResponse,
  ChatsGetChatSessionData,
  ChatsGetChatSessionResponse,
  ChatsGetChatMessagesData,
  ChatsGetChatMessagesResponse,
  ChatsCreateNewMessageData,
  ChatsCreateNewMessageResponse,
  UsersGetUsersData,
  UsersGetUsersResponse,
  UsersCreateUserData,
  UsersCreateUserResponse,
  UsersGetUserMeResponse,
  UsersDeleteUserMeResponse,
  UsersUpdateUserMeData,
  UsersUpdateUserMeResponse,
  UsersUpdateMyPasswordData,
  UsersUpdateMyPasswordResponse,
  UsersGetUserByIdData,
  UsersGetUserByIdResponse,
  UsersUpdateUserByIdData,
  UsersUpdateUserByIdResponse,
  UsersDeleteUserByIdData,
  UsersDeleteUserByIdResponse,
  UtilsHealthCheckResponse,
  UtilsHtmlResponse,
  UtilsTestSendEmailData,
  UtilsTestSendEmailResponse,
  UtilsTestSendEmailBackgroundData,
  UtilsTestSendEmailBackgroundResponse,
} from './types.gen';
...
export class AuthService {
  ...
  public static loginForAccessToken(
    data: AuthLoginForAccessTokenData,
  ): CancelablePromise<AuthLoginForAccessTokenResponse> {
...
export class ChatsService {
  ...
  public static createChatSession(
    data: ChatsCreateChatSessionData,
  ): CancelablePromise<ChatsCreateChatSessionResponse> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/api/v1/chats/chat_sessions',
      body: data.requestBody,
  ...
  public static getChatSession(
    data: ChatsGetChatSessionData,
  ): CancelablePromise<ChatsGetChatSessionResponse> {
    return __request(OpenAPI, {
      method: 'GET',
  ...
  public static getChatMessages(
    data: ChatsGetChatMessagesData,
  ): CancelablePromise<ChatsGetChatMessagesResponse> {
    return __request(OpenAPI, {
      method: 'GET',
  ...
  public static createNewMessage(
    data: ChatsCreateNewMessageData,
  ): CancelablePromise<ChatsCreateNewMessageResponse> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/api/v1/chats/chat_sessions/{chat_session_id}/messages',
      path: {
...
export class UsersService {
  ...
  public static updateMyPassword(
    data: UsersUpdateMyPasswordData,
  ): CancelablePromise<UsersUpdateMyPasswordResponse> {
    return __request(OpenAPI, {
      method: 'PATCH',
  ...
  public static getUserById(
    data: UsersGetUserByIdData,
  ): CancelablePromise<UsersGetUserByIdResponse> {
    return __request(OpenAPI, {
      method: 'GET',
  ...
  public static updateUserById(
    data: UsersUpdateUserByIdData,
  ): CancelablePromise<UsersUpdateUserByIdResponse> {
    return __request(OpenAPI, {
      method: 'PATCH',
      url: '/api/v1/users/{user_id}',
      path: {
  ...
  public static deleteUserById(
    data: UsersDeleteUserByIdData,
  ): CancelablePromise<UsersDeleteUserByIdResponse> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/api/v1/users/{user_id}',
      path: {
...
export class UtilsService {
   ...
   * @throws ApiError
   */
  public static testSendEmail(
    data: UtilsTestSendEmailData,
  ): CancelablePromise<UtilsTestSendEmailResponse> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static testSendEmailBackground(
    data: UtilsTestSendEmailBackgroundData,
  ): CancelablePromise<UtilsTestSendEmailBackgroundResponse> {
    return __request(OpenAPI, {
      method: 'GET',
