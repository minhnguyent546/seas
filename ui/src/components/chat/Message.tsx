  ...
  return (
    <div className="group flex items-start gap-4 py-4">
      <Avatar className="rounded-xl">
        ...
        <AvatarFallback className="bg-blue-600 text-white rounded-xl">U</AvatarFallback>
      </Avatar>
...
export const BotMessage: React.FC<MessageProps> = ({ message }) => {
  return (
    <div className="group relative flex items-start gap-4 py-4">
      <Avatar className="rounded-xl">
        <AvatarFallback className="bg-primary text-white rounded-xl">AI</AvatarFallback>
      </Avatar>
      <div className="flex-1 space-y-2">
        <div className="flex items-center gap-2">
